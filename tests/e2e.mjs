...
async function run() {
  ...
  result = await jsonRequest("/api/admin/content", "POST", { slug: contentSlug, category: "E2E", title: "E2E content update", excerpt: "A temporary content record.", body: "This content is used to verify the publishing workflow.", tags: ["e2e", "studio"], active: false })
  assert.equal(result.response.status, 201)
